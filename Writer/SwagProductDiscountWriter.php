...
namespace SwagProductDiscount\Writer;
...
use SwagProductDiscount\Event\SwagProductDiscountWriteExtenderEvent;
use SwagProductDiscount\Event\SwagProductDiscountWrittenEvent;
use SwagProductDiscount\Writer\Resource\SwagProductDiscountWriteResource;

class SwagProductDiscountWriter
{
    /**
     * @var DefaultExtender
     */
    ...
    public function update(array $data, TranslationContext $context): SwagProductDiscountWrittenEvent
    {
        ...
        foreach ($data as $swagProductDiscount) {
            try {
        ...
        return SwagProductDiscountWriteResource::createWrittenEvent($updated, $context, $errors);
    }
    ...
    public function upsert(array $data, TranslationContext $context): SwagProductDiscountWrittenEvent
    {
        ...
        return SwagProductDiscountWriteResource::createWrittenEvent($created, $context, $errors);
    }
    ...
    private function getExtender(): FieldExtenderCollection
    {
        ...
        $event = new SwagProductDiscountWriteExtenderEvent($extenderCollection);
        $this->eventDispatcher->dispatch(SwagProductDiscountWriteExtenderEvent::NAME, $event);
